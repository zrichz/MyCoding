...
class ImageInterleaver:
    ...
    def setup_ui(self):
        ...
        instructions = tk.Label(self.root, 
                               text="Select 4 images of the same dimensions. Each chunk will be divided into 4 quadrants:",
                               font=("Arial", 14))
        instructions.pack(pady=8)
        
        pattern_info = tk.Label(self.root,
                               text="Each chunk pattern:\n[Image 1] [Image 2]\n[Image 3] [Image 4]",
                               font=("Arial", 12, "italic"))
        pattern_info.pack(pady=8)
        ...
        for i, ((row, col), label) in enumerate(zip(positions, labels)):
            ...
            preview = tk.Label(frame, text="No image selected", 
                             width=25, height=12, bg="lightgray", font=("Arial", 10))
