...
PRIMARY_STAGES = {
    ...
    "Pose and action": [
        ...
        "standing under an umbrella, slight smile",
    ...
    "Clothing and key props": [
        ...
        "work jacket and boots",
        "simple blouse and trousers",
        ...
        "wool hat and gloves",
        "checked shirt and boots",
        "light cardigan and jeans",
        "work boots and utility jacket",
    ],
    "Expression and gaze": [
        "soft smile, looking slightly off-camera",
        "neutral expression, direct gaze",
        "candid smile, eyes down",
        "contemplative, looking to the left",
        "gentle laugh, head tilted",
        "focused, looking at hands",
        "relaxed, eyes half-closed",
        "slight grin, looking away",
        "thoughtful, distant gaze",
        "subtle smile, direct eye contact",
        "soft expression, looking up",
        "calm, eyes on horizon",
        "mild amusement, glancing aside",
        "serene, slight smile",
        "pensive, looking downwards",
        "warm smile, eyes crinkled",
        "reserved smile, head slightly bowed",
        "gentle smirk, looking off-frame",
        "open smile, candid expression",
        "softly serious, direct gaze",
        "subdued smile, eyes to camera",
        "mild surprise, eyebrows raised",
        "relaxed grin, looking to side",
        "quiet contentment, eyes closed briefly",
        "slight frown, thoughtful",
        "gentle curiosity, head tilt",
        "soft laugh, looking down",
        "calm, steady gaze",
        "subtle amusement, eyes to left",
        "warm, approachable smile",
        "reflective, distant look",
        "mildly inquisitive, direct gaze",
        "soft grin, slight squint",
        "content expression, relaxed eyes",
        "quiet smile, head turned slightly",
        "gentle amusement, eyes lowered",
        "softly bemused, looking aside",
...
SECONDARY_CATEGORIES = {
    ...
    "Depth of field / Bokeh": [
        ...
        "soft background with texture hint",
        "slight bokeh, natural falloff",
        "soft edge blur, subject crisp",
        "moderate blur, context preserved",
        "tight focus on face, soft shoulders",
        "soft bokeh with subtle chromatic fringing",
        "gentle background blur, natural",
        "shallow DOF, subtle rim separation",
        "soft bokeh, low-key highlights",
        "moderate DOF, hands visible",
        "shallow DOF, slight motion blur in background",
        "soft background blur, natural depth",
        "tight focus on eyes, soft surroundings",
        "gentle bokeh, natural falloff",
        "moderate DOF for environmental hint",
        "soft bokeh, subtle texture in background",
        "shallow DOF, natural separation",
        "slight background blur, readable context",
        "soft bokeh, minimal artifacts",
    ],
    "Texture / Finish": [
        "subtle film grain",
    ...
    "Mood / Subtle effects": [
        ...
        "gentle nostalgia, restrained",
        "calm, approachable atmosphere",
        "subtle warmth, homely",
        "slight melancholy, natural",
        "softly cheerful, candid",
