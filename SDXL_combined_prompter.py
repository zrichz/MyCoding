...
PRIMARY_STAGES = {
    ...
    "Clothing and key props": [
        ...
        "Soul Calibur cosplay outfit in blue and silver",
        "pastel pink abstract art print tee with light wash denim booty shorts",
        "dark purple monogram print evening clubwear",
        "sage green botanical print tight summer dress with floral pattern",
